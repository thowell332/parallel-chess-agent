...
int testCorrectness()
{
    ...
    std::cout << "Testing checkmate in one..." << std::endl;
    {
        ...
        */
        ...
        auto selectedMove = alphaBeta(SharedMemoryTag{}, *root, 1);
    ...
    std::cout << "Testing checkmate in two..." << std::endl;
    {
        ...
        */
        ...
        auto root = std::make_unique<GameNode>(startPos);
        auto selectedMove = alphaBeta(SharedMemoryTag{}, *root, 3);
        ...
        selectedMove = alphaBeta(SharedMemoryTag{}, *root, 2);
        // Black to move: Anywhere
        root->makeMove(selectedMove);
        selectedMove = alphaBeta(SharedMemoryTag{}, *root, 1);
